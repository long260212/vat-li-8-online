...
import { BookOpen, Award, CheckCircle2, Flame, ArrowRight, Lightbulb, RefreshCw, Zap, FlaskConical } from 'lucide-react';
    ...
    <div id="dashboard-view" className="space-y-8">
        ...
        <div className="relative z-10 max-w-2xl space-y-4">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            ...
            <button
              ...
              className="px-6 py-3 rounded-xl bg-cyan-600 hover:bg-cyan-700 text-white font-medium shadow-lg shadow-cyan-500/10 transition-all flex items-center gap-2 cursor-pointer"
            >
              Thí nghiệm ảo
            </button>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {/* Virtual Lab Center */}
          <div className="bg-gradient-to-br from-cyan-50 to-blue-50/50 dark:from-cyan-950/20 dark:to-blue-950/10 p-6 rounded-2xl border border-cyan-100/60 dark:border-cyan-900/40 shadow-sm space-y-4">
            <div className="flex items-center gap-2.5">
              <span className="p-2 bg-cyan-600 text-white rounded-xl font-bold"><FlaskConical size={16} /></span>
              <h3 className="text-base font-black text-slate-800 dark:text-slate-100">Phòng thí nghiệm ảo</h3>
            </div>
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              Mô phỏng tương tác cho các bài Áp suất, Áp suất chất lỏng, Lực đẩy Ác-si-mét và Cân bằng nhiệt. Học sinh kéo thông số, nhìn kết quả và tự rút ra công thức.
            </p>
            <button
              onClick={() => onNavigate('virtual-lab')}
              className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-600 hover:bg-cyan-700 text-white text-xs font-bold rounded-xl transition-all cursor-pointer"
            >
              Mở thí nghiệm ảo <ArrowRight size={14} />
            </button>
          </div>
